---
layout: post
title: Fantasy Hocky Player Value Prediction
---
<style>
.center {
  display: block;
...
<figure>
  <img src="../images/p2_auction.jpg" alt="bid" class="center">
  <figcaption class="center">(Getty Images)</figcaption>
</figure>
<br/>
...
```
alphavec = 10**np.linspace(0.01,2,200) # list of alpha values to try
...
<img src="../images/p2_pred_vs_avg_value.png" alt="bid" class="center">
<br/>
...
<img src="../images/p2_avg_val_hist.png" alt="bid" class="center">
